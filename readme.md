...
Questa repository contiene una serie di progetti pratici sviluppati per esplorare e comprendere i concetti fondamentali dell'Intelligenza Artificiale, passando dal Machine Learning classico (dati tabellari) al Deep Learning (serie temporali).
...
* **Dataset:** [Credit Card Fraud Detection (Kaggle)](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud) - Dati reali di transazioni europee del 2013.
